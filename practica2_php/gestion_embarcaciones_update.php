...
<head>
	<title> Gestion de Embarcaciones Update</title>
	<meta charset="utf-8">
...
<body>
	...
	<main>
		...
		<section>
			<form method="post" action="gestion_embarcaciones_update_II.php">
			<table border="1" align="center">
				...
				<?php
						...
						$resultado = $consulta -> fetchAll();
							...
							echo "<tr>";
							echo "<td><center><input type=radio name=editar value=$matricula></center></td>";
				...
				<br><input type="submit" value="Editar Embarcacion Seleccionada">
				</form>
		</section>
