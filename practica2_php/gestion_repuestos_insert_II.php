...
<head>
	<title> Gestion de Repuestos Insert II </title>
	<meta charset="utf-8">
...
<body>
	...
	<main>
		...
		<?php
			...
			if(!$result){
				echo "<br/>Error al introducir el repuesto en la DB";
			}
			else{
				echo "<br/>Repuesto introducido con éxito";
			}
