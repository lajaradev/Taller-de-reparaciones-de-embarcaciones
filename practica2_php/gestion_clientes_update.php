...
<body>
	...
	<main>
		...
		<section>
			...
			<form method="post" action="gestion_clientes_update_II.php">
			...
			<?php
					...
					foreach ($resultado as $fila) {
						...
						echo "<tr>";
						echo "<td><center><input type=radio name=editar value=$id_cliente></center></td>";
				...
				<br><input type="submit" value="Editar Cliente Seleccionado">
