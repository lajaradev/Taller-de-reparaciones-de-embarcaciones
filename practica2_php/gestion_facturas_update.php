...
<body>
	...
	<main>
		...
		<section>
			<form method="post" action="gestion_facturas_update_II.php">
			<table border="1" align="center">

				<tr><td>SELECT</td><td>NUM FACTURA</td><td>MATRICULA</td><td>MANO DE OBRA</td><td>PRECIO/HORA</td><td>FECHA/EMISION</td><td>FECHA/PAGO</td><td>BASE IMPONIBLE</td><td>IVA</td><td>TOTAL</td></tr>
				...
				<?php
						...
						$resultado = $consulta -> fetchAll();
							...
							echo "<tr>";
							echo "<td><center><input type=radio name=editar value=$numero_factura></center></td>";
			...
			<br><input type="submit" value="Editar Factura Seleccionada">
		</form>
		</section>
