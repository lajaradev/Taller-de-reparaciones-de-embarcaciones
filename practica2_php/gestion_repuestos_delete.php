...
<body>
	...
	<main>
		...
		<section>
			<form method="post" action="gestion_repuestos_delete_II.php">
			<table border="1" align="center">
				...
				<?php
						...
						$resultado = $consulta -> fetchAll();
							...
							echo "<tr>";
							echo "<td><center><input type=checkbox name=borrar[] value=$referencia></center></td>";
			...
			<br><input type="submit" value="Eliminar Repuesto(s) Seleccionado(s)">
